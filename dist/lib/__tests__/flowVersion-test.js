...
describe('flowVersion', function () {
  describe('parseVersion', function () {
    ...
    it('errors on `x` major version', function () {
      ...
      }).toThrow('vx.1.2: The major version of a Flow version string cannot be `x`, ' + 'it must be a number!');
    });

    it('errors on missing minor version', function () {
      expect(function () {
        return (0, _flowVersion.__parseVersion)('v1', false);
      }).toThrow('v1: Flow versions must be a non-range semver with an exact major ' + 'version and either an exact minor version or an `x` minor ver.');
    });
  ...
  describe('parseDirString', function () {
    it('parses a flow-all version', function () {
      expect((0, _flowVersion.parseDirString)('flow_all')).toEqual({ kind: 'all' });
    });
  ...
  describe('toSemverString', function () {
    it('serializes `flow_all` versions', function () {
      expect((0, _flowVersion.toSemverString)({ kind: 'all' })).toBe('vx.x.x');
    });
  ...
  describe('toDirString', function () {
    it('serializes `flow_all` versions', function () {
      expect((0, _flowVersion.toDirString)({ kind: 'all' })).toBe('flow_all');
    });
